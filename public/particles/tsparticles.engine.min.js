  ...
  (() => {
    ...
    t.r(e),
      t.d(e, {
        ...
        Parallax: () => ne,
        ParticlesBounce: () => ze,
        ParticlesBounceFactor: () => xe,
        ParticlesDensity: () => Ve,
        ParticlesInteractorBase: () => xi,
        ParticlesNumber: () => Be,
        ParticlesOptions: () => Qe,
        Point: () => ni,
        Range: () => ai,
        ...
        areBoundsInside: () => W,
        arrayRandomIndex: () => V,
        calcExactPositionOrRandomFromSize: () => k,
        calcExactPositionOrRandomFromSizeRanged: () => S,
        calcPositionFromSize: () => M,
        calcPositionOrRandomFromSize: () => P,
        calcPositionOrRandomFromSizeRanged: () => O,
        calculateBounds: () => U,
        cancelAnimation: () => A,
        circleBounce: () => Y,
        ...
        drawLine: () => Mt,
        drawParticle: () => Ct,
        drawParticlePlugin: () => Et,
        drawPlugin: () => It,
        drawShape: () => Rt,
        drawShapeAfterEffect: () => Tt,
        drawTriangle: () => Pt,
        ...
        getHslFromAnimation: () => _t,
        getLinkColor: () => bt,
        getLinkRandomColor: () => wt,
        getParticleBaseVelocity: () => x,
        getParticleDirectionAngle: () => _,
        getRandom: () => c,
        getRandomRgbColor: () => ft,
        getRangeMax: () => m,
        getRangeMin: () => f,
        getRangeValue: () => v,
        getStyleFromHsl: () => gt,
    ...
    class i {
      ...
      addEventListener(t, e) {
        ...
        this.removeEventListener(t, e),
          ...
          null === (i = this._listeners.get(t)) || void 0 === i || i.push(e);
      }
      dispatchEvent(t, e) {
        var i;
    ...
    function y(t) {
      ...
      return v(i ? g(t.value, s) : t.value);
    }
    function b(t, e) {
      const i = t.x - e.x,
        s = t.y - e.y;
    ...
    function O(t) {
      ...
      const s = {
        x:
          void 0 !== (null === (e = t.position) || void 0 === e ? void 0 : e.x)
            ? v(t.position.x)
            : void 0,
        y:
    ...
    function S(t) {
      ...
      return k({ size: t.size, position: s });
    }
    function C(t) {
    ...
    function I() {
      return !T() && "undefined" != typeof matchMedia;
    }
    function E(t) {
      if (I()) return matchMedia(t);
    }
    function D() {
      return T()
        ? (t) => setTimeout(t)
    ...
    async function F(t, e) {
      try {
        await document.fonts.load(
          `${null != e ? e : "400"} 36px '${null != t ? t : "Verdana"}'`
        );
      } catch (t) {}
    }
    function V(t) {
      return Math.floor(c() * t.length);
    }
    function B(t, e, i = !0) {
      return t[void 0 !== e && i ? e % t.length : V(t)];
    }
    function H(t, e, i, s, o) {
      return W(U(t, null != s ? s : 0), e, i, o);
    }
    function W(t, e, i, s) {
      let o = !0;
      return (
      ...
      for (const i of e) {
        ...
        for (const e in i) {
          ...
          const s = i[e],
            o = "object" == typeof s,
            n = t;
          n[e] = o && Array.isArray(s) ? s.map((t) => q(n[e], t)) : q(n[e], s);
        }
      }
      return t;
    }
    ...
    function rt(t, e, i = !0) {
      ...
      if ("string" == typeof s.value)
        return s.value === tt ? ft() : ut(s.value);
    ...
    function ft(t) {
      const e = null != t ? t : 0;
      return {
        b: Math.floor(p(g(e, 256))),
        g: Math.floor(p(g(e, 256))),
        r: Math.floor(p(g(e, 256))),
      };
    }
    function mt(t, e) {
    ...
    function yt(t, e, i, s) {
      ...
      return (
        void 0 === o.r && (o = pt(t)),
        void 0 === n.r && (n = pt(e)),
        { b: u(o.b, n.b, i, s), g: u(o.g, n.g, i, s), r: u(o.r, n.r, i, s) }
      );
    }
    function bt(t, e, i) {
      var s, o;
        ...
        const i =
          ...
          n =
            null !== (o = null == e ? void 0 : e.getFillColor()) && void 0 !== o
              ...
              ? void 0
              : e.getStrokeColor();
        if (i && n && e) return yt(i, n, t.getRadius(), e.getRadius());
        {
          const t = null != i ? i : n;
          if (t) return pt(t);
        }
    ...
    function zt(t, e, i) {
      (t.enable = e.enable),
        t.enable
          ? ((t.velocity = (v(e.speed) / 100) * i),
            (t.decay = 1 - v(e.decay)),
            (t.status = "increasing"),
            (t.loops = 0),
            (t.maxLoops = v(e.count)),
            e.sync || ((t.velocity *= c()), (t.value *= c())),
    ...
    function Ct(t) {
      ...
      const {
        ...
        g = l.getPosition(),
        y = l.rotation + (l.pathRotation ? l.velocity.angle : 0),
        b = Math.sin(y),
        w = Math.cos(y),
        _ = {
          a: w * (null !== (e = m.a) && void 0 !== e ? e : 1),
          b: b * (null !== (i = m.b) && void 0 !== i ? i : 1),
          c: -b * (null !== (s = m.c) && void 0 !== s ? s : 1),
          d: w * (null !== (o = m.d) && void 0 !== o ? o : 1),
        };
      r.setTransform(_.a, _.b, _.c, _.d, g.x, g.y),
        r.beginPath(),
    ...
    class Xt {
      constructor(t) {
        (this.container = t),
          ...
          (this._mutationObserver =
            T() || "undefined" == typeof MutationObserver
              ? void 0
      ...
      clear() {
        ...
        t.backgroundMask.enable
          ...
          ? i.color
            ? this._paintBase(mt(i.color, i.opacity))
          ...
          (a || r) &&
            this.draw((i) => {
              ...
              const c = this.container.actualOptions,
                ...
                m = {},
                g = { fill: a ? gt(a, v) : void 0 };
              (g.stroke = r ? gt(r, f) : g.fill),
                this._applyPreDrawUpdaters(i, t, s, v, g, m),
                Ct({
      ...
      initBackground() {
        ...
        if (i) {
          if (t.color) {
            const e = at(t.color);
            i.backgroundColor = e ? mt(e, t.opacity) : "";
      ...
      loadCanvas(t) {
        ...
        this._generated &&
          (null === (e = this.element) || void 0 === e || e.remove()),
          (this._generated =
            t.dataset && At in t.dataset
              ? "true" === t.dataset[At]
              : this._generated),
          (this.element = t),
          (this.element.ariaHidden = "true"),
          (this._originalStyle = q({}, this.element.style)),
      ...
      paint() {
        ...
        this.draw((e) => {
          t.backgroundMask.enable && t.backgroundMask.cover
            ? (St(e, this.size), this._paintBase(this._coverColorStyle))
            : this._paintBase();
        });
      }
      resize() {
      ...
      _getPluginParticleColors(t) {
        ...
        for (const s of this._colorPlugins)
          if (
            (!e && s.particleFillColor && (e = ht(s.particleFillColor(t))),
            !i && s.particleStrokeColor && (i = ht(s.particleStrokeColor(t))),
            e && i)
          )
            break;
        return [e, i];
      ...
      _initCover() {
        ...
        if (e) {
          ...
          this._coverColorStyle = mt(i, i.a);
        }
      }
      _initStyle() {
    ...
    class Jt {
      ...
      doMouseTouchClick(t) {
        ...
        if (this.canPush) {
          ...
          Z(i.interactivity.events.onClick.mode, (t) =>
      ...
      manageListeners(t) {
        ...
        let a = Ut;
        if ("window" === n) (s.interactivity.element = window), (a = qt);
        ...
        const r = E("(prefers-color-scheme: dark)");
        r &&
          (void 0 !== r.addEventListener
            ? Yt(r, "change", i.themeChange, t)
        ...
        (o.interactivity.events.onHover.enable ||
          ...
          Yt(l, Ht, i.touchStart, t),
          Yt(l, Wt, i.touchMove, t),
          o.interactivity.events.onClick.enable
            ? (Yt(l, Lt, i.touchEndClick, t),
              Yt(l, Vt, i.mouseUp, t),
              Yt(l, Ft, i.mouseDown, t))
            : Yt(l, Lt, i.touchEnd, t),
          Yt(l, a, i.mouseLeave, t),
          Yt(l, Gt, i.touchCancel, t)),
          s.canvas.element &&
          ...
          o.interactivity.events.resize &&
            ("undefined" != typeof ResizeObserver
              ...
              : Yt(window, Nt, i.resize, t)),
          document && Yt(document, jt, i.visibilityChange, t, !1);
      }
      mouseDown() {
        ...
        if (t.type.startsWith("pointer")) {
          ...
          if (l.interactivity.element === window) {
            if (d) {
              ...
              c = { x: e.clientX - t.left, y: e.clientY - t.top };
            }
    ...
    class Zt {
      ...
      async nextFrame(t) {
        ...
        try {
          ...
          if (((i.lifeTime += s.value), (i.lastFrameTime = t), s.value > 1e3))
            return void i.draw(!1);
          if (
    ...
    class de {
      load(t) {
        ...
        t &&
          ...
          void 0 !== t.options && (this.options = q({}, t.options)));
      }
    }
    class ue {
      constructor() {
    ...
    class fe {
      ...
      load(t) {
        t &&
          (void 0 !== t.count && (this.count = g(t.count)),
          void 0 !== t.enable && (this.enable = t.enable),
          void 0 !== t.offset && (this.offset = g(t.offset)),
          void 0 !== t.speed && (this.speed = g(t.speed)),
          void 0 !== t.decay && (this.decay = g(t.decay)),
          void 0 !== t.sync && (this.sync = t.sync));
      }
    }
    class me {
      constructor() {
        (this.h = new fe()), (this.s = new fe()), (this.l = new fe());
      }
      load(t) {
    ...
    class Pe {
      ...
      load(t) {
        t &&
          (void 0 !== t.offset && (this.offset = g(t.offset)),
          void 0 !== t.value && (this.value = g(t.value)));
      }
    }
    class Oe {
      constructor() {
      ...
      load(t) {
        var e, i, s, o;
        if (!t) return;
        void 0 !== t.distance && (this.distance = g(t.distance)),
          void 0 !== t.enable && (this.enable = t.enable);
        const n =
          null !==
    ...
    class Se {
      ...
      load(t) {
        t &&
          (void 0 !== t.acceleration && (this.acceleration = g(t.acceleration)),
          void 0 !== t.enable && (this.enable = t.enable),
          void 0 !== t.inverse && (this.inverse = t.inverse),
          void 0 !== t.maxSpeed && (this.maxSpeed = g(t.maxSpeed)));
      }
    }
    class Ce {
      constructor() {
      ...
      load(t) {
        t &&
          ...
          t.options && (this.options = q(this.options, t.options)));
      }
    }
    class Re {
      load(t) {
    ...
    class Te {
      constructor() {
        (this.enable = !1), (this.length = 10), (this.fill = new Re());
      }
      get fillColor() {
    ...
    class Ee {
      ...
      load(t) {
        t &&
          (void 0 !== t.acceleration && (this.acceleration = g(t.acceleration)),
          void 0 !== t.enable && (this.enable = t.enable),
          (this.position = t.position ? q({}, t.position) : void 0));
      }
    }
    class De {
      constructor() {
      ...
      load(t) {
        ...
        this.angle.load(
          ...
          void 0 !== t.drift && (this.drift = g(t.drift)),
          void 0 !== t.enable && (this.enable = t.enable),
          this.gravity.load(t.gravity);
        const o =
          null !==
            (i = null !== (e = t.outModes) && void 0 !== e ? e : t.outMode) &&
          void 0 !== i
            ? i
            : t.out_mode;
        void 0 !== o &&
    ...
    class Ve {
      ...
      load(t) {
        ...
        void 0 !== t.enable && (this.enable = t.enable);
        const o =
          null !== (i = null !== (e = t.width) && void 0 !== e ? e : t.area) &&
          void 0 !== i
            ? i
            : t.value_area;
    ...
    class Be {
      constructor() {
        (this.density = new Ve()), (this.limit = 0), (this.value = 100);
      }
      get max() {
        return this.limit;
      }
    ...
    class $e {
      ...
      get character() {
        var t;
        return null !== (t = this.options[We]) && void 0 !== t
          ? t
          : this.options[Ue];
      }
      set character(t) {
        this.options[Ue] = this.options[We] = t;
      }
      get custom() {
        return this.options;
      }
      ...
      get image() {
        var t;
        return null !== (t = this.options[qe]) && void 0 !== t
          ? t
          : this.options[Ge];
      }
      set image(t) {
        this.options[Ge] = this.options[qe] = t;
      }
      get images() {
        return this.image;
      }
      ...
      get polygon() {
        var t;
        return null !== (t = this.options[Ne]) && void 0 !== t
          ? t
          : this.options[je];
      }
      set polygon(t) {
        this.options[je] = this.options[Ne] = t;
      }
      get stroke() {
        return [];
      }
      ...
      load(t) {
        ...
        this.loadShape(t.character, We, Ue, !0),
          this.loadShape(t.polygon, Ne, je, !1),
          this.loadShape(
      ...
      loadShape(t, e, i, s) {
        ...
        const a = t instanceof Array,
          ...
          h = a !== this.options[i] instanceof Array;
        l && (this.options[e] = r),
          h && s && (this.options[i] = r),
          (this.options[e] = q(
            null !== (o = this.options[e]) && void 0 !== o ? o : r,
            t
          )),
          (this.options[i] && !s) ||
            (this.options[i] = q(
              null !== (n = this.options[i]) && void 0 !== n ? n : r,
              t
            ));
      }
    }
    ...
    class Je {
      ...
      load(t) {
        t &&
          (void 0 !== t.color && (this.color = ge.create(this.color, t.color)),
          void 0 !== t.width && (this.width = g(t.width)),
          void 0 !== t.opacity && (this.opacity = g(t.opacity)));
      }
    }
    class Ze extends _e {
      constructor() {
    ...
    class Qe {
      ...
      load(t) {
        ...
        if (
          (this.bounce.load(t.bounce),
          this.color.load(ge.create(this.color, t.color)),
          void 0 !== t.groups)
        )
        ...
        const r =
          null !==
            (s =
              null === (i = t.move) || void 0 === i ? void 0 : i.collisions) &&
          void 0 !== s
            ? s
        ...
        void 0 !== r && (this.collisions.enable = r),
          ...
          void 0 !== t.interactivity &&
            (this.interactivity = q({}, t.interactivity));
        const l =
    ...
    class ei {
      ...
      load(t) {
        ...
        void 0 !== t.preset && Z(t.preset, (t) => this._importPreset(t)),
          ...
          void 0 !== t.delay && (this.delay = g(t.delay));
        const a =
          null !== (e = t.detectRetina) && void 0 !== e ? e : t.retina_detect;
        void 0 !== a && (this.detectRetina = a),
          void 0 !== t.duration && (this.duration = g(t.duration));
      ...
      setTheme(t) {
        if (t) {
          ...
          const t = E("(prefers-color-scheme: dark)"),
            e = t && t.matches,
    ...
    class oi {
      ...
      getFillColor() {
        ...
        return this._getRollColor(
          null !== (t = this.bubble.color) && void 0 !== t ? t : _t(this.color)
        );
      }
      getMass() {
      ...
      init(t, e, i, s) {
        ...
        const M = x.retina.pixelRatio,
          P = x.actualOptions,
          O = ti(this._engine, x, P.particles),
          k = O.shape.type,
          { reduceDuplicates: S } = O;
        this.shape = Q(k, this.id, S);
        const C = O.shape;
        if (i && i.shape && i.shape.type) {
          const t = Q(i.shape.type, this.id, S);
          t && ((this.shape = t), C.load(i.shape));
        }
        (this.shapeData = this._loadShapeData(C, S)),
          O.load(i),
          O.load(
            null === (n = this.shapeData) || void 0 === n ? void 0 : n.particles
          ),
          (this.interactivity = new ce(z, x)),
          this.interactivity.load(x.actualOptions.interactivity),
          this.interactivity.load(O.interactivity),
          (this.fill =
            null !==
              (r =
        ...
        (this.pathDelay = 1e3 * y(R.delay)),
          R.generator &&
            ((this.pathGenerator = this._engine.plugins.getPathGenerator(
              R.generator
            )),
            this.pathGenerator &&
              x.addPath(R.generator, this.pathGenerator) &&
              this.pathGenerator.init(x));
        const T = v(this.options.zIndex.value);
        ...
        if (
          ((this.size = {
            ...
            value: v(I.value) * x.retina.pixelRatio,
            max: m(E) * M,
            min: f(E) * M,
            loops: 0,
          ...
          switch (
            ...
            case "min":
              ...
              break;
            case "random":
              (this.size.value = p(this.size)),
                (this.size.status = c() >= 0.5 ? "increasing" : "decreasing");
              break;
            default:
        ...
        (this.size.initialValue = this.size.value),
          ...
          (this.position = this._calcPosition(x, e, d(T, 0, x.zLayers))),
        ...
        (V.needsSort = V.needsSort || V.lastZIndex < this.position.z),
          ...
          (this.sides = 24);
        let B = x.drawers.get(this.shape);
        B ||
          ((B = this._engine.plugins.getShapeDrawer(this.shape)),
          B && x.drawers.set(this.shape, B)),
          (null == B ? void 0 : B.loadShape) &&
            (null == B || B.loadShape(this));
        const H = null == B ? void 0 : B.getSidesCount;
        H && (this.sides = H(this)),
          (this.spawning = !1),
        ...
        (null == B ? void 0 : B.particleInit) && B.particleInit(x, this);
      ...
      _calcPosition(t, e, i, o = 0) {
        ...
        const h = k({ size: t.canvas.size, position: e }),
          c = s.create(h.x, h.y, i),
          d = this.getRadius(),
        ...
        return (
          ...
          this._checkOverlap(c, o) ? this._calcPosition(t, void 0, i, o + 1) : c
        );
      }
      _calculateVelocity() {
        ...
        return (
          e.straight || (t.angle += p(g(o.left, o.right))),
          e.random && "number" == typeof e.speed && (t.length *= c()),
          t
        );
      }
      _checkOverlap(t, e = 0) {
      ...
      _getRollColor(t) {
        ...
        return Math.floor(
          ...
          ? this.backColor
            ? this.backColor
            : this.roll.alter
            ? Dt(t, this.roll.alter.type, this.roll.alter.value)
            : t
          : t;
      }
      _loadShapeData(t, e) {
        const i = t.options[this.shape];
        if (i) return q({}, Q(i, this.id, e));
      }
    }
    class ni {
      constructor(t, e) {
      ...
      intersects(t) {
        ...
        if (void 0 !== e.size) {
          const t = e.size.width,
            i = e.size.height;
          return (
            Math.pow(n - t, 2) + Math.pow(a - i, 2) <= r ** 2 ||
            (n <= r + t && a <= r + i) ||
            n <= t ||
            a <= i
          );
    ...
    class hi {
        ...
        return (
          ...
          (this._points.length < this.capacity
            ...
            : (this._divided || this.subdivide(),
              null !==
                (n =
                  (null === (e = this._NE) || void 0 === e
                    ? void 0
                    : e.insert(t)) ||
                  (null === (i = this._NW) || void 0 === i
                    ? void 0
                    : i.insert(t)) ||
      ...
      query(t, e, i) {
        ...
        for (const i of this._points)
          (!t.contains(i.position) &&
            w(t.position, i.position) > i.particle.getRadius() &&
            (!e || e(i.particle))) ||
            r.push(i.particle);
        return (
          this._divided &&
      ...
      subdivide() {
        const t = this.rectangle.position.x,
          ...
          o = this.capacity;
        (this._NE = new hi(new li(t, e, i / 2, s / 2), o)),
          (this._NW = new hi(new li(t + i / 2, e, i / 2, s / 2), o)),
          (this._SE = new hi(new li(t, e + s / 2, i / 2, s / 2), o)),
          (this._SW = new hi(new li(t + i / 2, e + s / 2, i / 2, s / 2), o)),
          (this._divided = !0);
      }
    }
    class ci {
      ...
      addManualParticles() {
        ...
        for (const i of e.manualParticles)
          this.addParticle(
            M({ size: t.canvas.size, position: i.position }),
            i.options
          );
      }
      addParticle(t, e, i, s) {
      ...
      async update(t) {
        ...
        for (const e of this.array) {
          ...
          n &&
            ...
            ((e.position.x *= n.width),
            (e.position.y *= n.height),
            (e.initialPosition.x *= n.width),
            (e.initialPosition.y *= n.height)),
          ...
          e.destroyed
            ? o.push(e)
            : this.quadTree.insert(new ni(e.getPosition(), e));
        }
        ...
        for (const e of this.array) {
          ...
          e.destroyed ||
            e.spawning ||
            (await this.interactionManager.particlesInteract(e, t));
        }
      ...
      _pushParticle(t, e, i, s) {
        try {
          let o = this.pool.pop();
          o
            ? o.init(this.nextId, t, e, i)
            : (o = new oi(this._engine, this.nextId, this.container, t, e, i));
          let n = !0;
          if ((s && (n = s(o)), !n)) return;
          return (
            this.array.push(o),
    ...
    class di {
      ...
      init() {
        const t = this.container,
          e = t.actualOptions;
        (this.pixelRatio =
          !e.detectRetina || T() ? 1 : window.devicePixelRatio),
          (this.reduceFactor = 1);
        ...
        const s = e.particles;
        (this.attractDistance = v(s.move.attract.distance) * i),
          (this.sizeAnimationSpeed = v(s.size.animation.speed) * i),
          (this.maxSpeed = v(s.move.gravity.maxSpeed) * i);
      }
      initParticle(t) {
        const e = t.options,
          i = this.pixelRatio,
          s = e.move.distance,
          o = t.retina;
        (o.attractDistance = v(e.move.attract.distance) * i),
          (o.moveDrift = v(e.move.drift) * i),
          (o.moveSpeed = v(e.move.speed) * i),
          (o.sizeAnimationSpeed = v(e.size.animation.speed) * i);
        const n = o.maxDistance;
        (n.horizontal = void 0 !== s.horizontal ? s.horizontal * i : void 0),
          (n.vertical = void 0 !== s.vertical ? s.vertical * i : void 0),
          (o.maxSpeed = v(e.move.gravity.maxSpeed) * i);
      }
    }
    function ui(t) {
    ...
    class fi {
      constructor(t, e, i) {
        (this.id = e),
          ...
          (this.retina = new di(this)),
          (this.canvas = new Xt(this)),
          (this.particles = new ci(this._engine, this)),
      ...
      addPath(t, e, i = !1) {
        return (
          !(!ui(this) || (!i && this.pathGenerators.has(t))) &&
          (this.pathGenerators.set(t, null != e ? e : vi), !0)
        );
      }
      destroy() {
        if (!ui(this)) return;
      ...
      async reset() {
        if (ui(this))
          return (this._options = pi(this._engine, this)), this.refresh();
      }
      setNoise(t, e, i) {
      ...
      _intersectionManager(t) {
        if (ui(this) && this.actualOptions.pauseOnOutsideViewport)
          for (const e of t)
    ...
    class mi {
      ...
      async loadJSON(t, e, i) {
        ...
        return (
          ...
          this.loadRemoteOptions({ tagId: o, url: s, index: i, remote: !0 })
        );
      }
      async loadOptions(t) {
        var e, i, s;
        ...
        if ("canvas" === h.tagName.toLowerCase())
          (v = h), (v.dataset[At] = "false");
        else {
          const t = h.getElementsByTagName("canvas");
          t.length
            ? ((v = t[0]), (v.dataset[At] = "false"))
        ...
        const f = new fi(this._engine, o, d);
        return (
    ...
    class yi {
      ...
      getInteractors(t, e = !1) {
        return gi(t, this.interactors, this._initializers.interactors, e);
      }
      getMovers(t, e = !1) {
        return gi(t, this.movers, this._initializers.movers, e);
      }
      getPathGenerator(t) {
      ...
      getUpdaters(t, e = !1) {
        return gi(t, this.updaters, this._initializers.updaters, e);
      }
      loadOptions(t, e) {
    ...
    class bi {
      ...
      handleRangeColor(t) {
        ...
        if (void 0 !== i.h && void 0 !== i.l)
          return pt({ h: v(i.h), l: v(i.l), s: v(i.s) });
      }
      parseString(t) {
    ...
    const Pi = new (class {
      constructor() {
        (this._domArray = []),
          (this._eventDispatcher = new i()),
          (this._initialized = !1),
          (this._loader = new mi(this)),
          (this.plugins = new yi(this));
      }
      addEventListener(t, e) {
